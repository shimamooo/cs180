...
Since I was still using for loops in code that depended on the dimensions of the image runtime-wise, the code took 3 minutes to run per image. After vectorizing, the code took just a few seconds to run per image.
