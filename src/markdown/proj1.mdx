...
![image](/cs180/proj1/emir-naive.jpg)
...
Eeryone but Emir was successfully aligned. This image is particularly difficult because of his outfit:
...
Instead, we should use the green channel as the reference channel. This way, we are more likely to align the extreme channels with it.
...
And as expected, the optimal blue shift here is the negative of the optimal green shift from when we used the blue channel as the reference channel.
